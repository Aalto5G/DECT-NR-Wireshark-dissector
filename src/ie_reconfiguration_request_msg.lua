function ie_handler_reconfiguration_request_message(loffset, lbuffer, lpinfo, lmac_mux_header)
    print("Reconfiguration request")
    local nw_reconfiguration_request_msg_hdr = lmac_mux_header:add("Reconfiguration Request Message Header")
